...
/*
 * it is assumed that you will be using "es/*.js" for ES2015+ and "scss/*.scss"
 * for SASS. You can change these as needed.
 ******************************************************************************/
var sourcePaths = {
    src: src,
    es: "es",
 ...
 * should be stored in "www/js", and that any generated CSS should be stored in
 * "www/css".
 ******************************************************************************/
var outputPaths = {
    www: "www",
...
var jsEntryFile = indexes.es.from,
